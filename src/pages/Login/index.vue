<template>
   <section class="loginContainer">
          ...
          <form @submit.prevent="login">
            <div :class="{on:loginway}">
              <section class="login_message">
                ...
                <button :disabled="!rightphone" class="get_verification" :class="{right_phone:rightphone}" @click.prevent="getCode">{{countTime > 0 ? `已发送(${countTime}s)`:'获取验证码'}}</button>
              </section>
      ...
      <Altertip :alertText="alertText" v-show="alertShow" @closeTip="closeTip"/>
    </section>
</template>
